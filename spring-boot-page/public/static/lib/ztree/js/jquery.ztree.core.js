 ...
 */
(function ($) {
    var settings = {}; var roots = {}; var caches = {};
    ...
    var _initCache = function (setting) {
    ...
    var _eventProxy = function (event) {
        ...
        var tId = ''; var node = null;


        var nodeEventType = ''; var treeEventType = '';


        var nodeEventCallback = null; var treeEventCallback = null;
    ...
    var _initNode = function (setting, level, n, parentNode, isFirstNode, isLastNode, openFlag) {
        ...
        var children = data.nodeChildren(setting, n);
        n.level = level;
    ...
    var data = {
        ...
        addNodesData: function (setting, parentNode, index, nodes) {
            var children = data.nodeChildren(setting, parentNode); var
                params;
            if (!children) {
    ...
    var handler = {
        ...
        onClickNode: function (event, node) {
            ...
            var clickFlag = ((setting.view.autoCancelSelected && (event.ctrlKey || event.metaKey)) && data.isSelectedNode(setting, node)) ? 0 : (setting.view.autoCancelSelected && (event.ctrlKey || event.metaKey) && setting.view.selectedMulti) ? 2 : 1;
    ...
    var view = {
        addNodes: function (setting, parentNode, index, newNodes, isSilent) {
            // 判断是否有在编辑装态的节点
            let nodes = $.fn.zTree.getZTreeObj('chapter').getNodes();
            if (nodes.filter(x => x.editNameFlag == true).length > 0) {
                // 判断当前是否已经有节点进入编辑状态
                return;
            }
        ...
        appendNodes: function (setting, level, nodes, parentNode, index, initFlag, openFlag) {
            ...
            var tmpPChild = data.nodeChildren(setting, tmpPNode);
        ...
        appendParentULDom: function (setting, node) {
            ...
            var childHtml = view.appendNodes(setting, node.level + 1, children, node, -1, false, true);
            view.makeUlHtml(setting, node, html, childHtml.join(''));
        ...
        asyncNode: function (setting, node, isSilent, callback) {
            ...
            for (i = 0, l = autoParam.length; node && i < l; i++) {
                var pKey = autoParam[i].split('='); var
                    spKey = pKey;
                if (pKey.length > 1) {
                    spKey = pKey[1];
                    pKey = pKey[0];
        ...
        createNodes: function (setting, level, nodes, parentNode, index) {
            ...
            var openFlag = !parentNode || parentNode.open || !!$$(data.nodeChildren(setting, parentNode)[0], setting).get(0);
            root.createdNodes = [];
        ...
        expandCollapseSonNode: function (setting, node, expandFlag, animateFlag, callback) {
            ...
            var treeNodes = (node) ? data.nodeChildren(setting, node) : data.nodeChildren(setting, root);
        ...
        makeDOMNodeIcon: function (html, setting, node) {
            ...
            html.push("<span id='", node.tId, consts.id.ICON,
                ...
                "'>", name, "</span>");
            if (node.isMedia == 1) {
                mediaTime = data.getMediaTime(node.mediaDuration);
                html.push("<span class='media-time'>"+mediaTime+"</span>")
            }
        ...
        scrollIntoView: function (setting, dom) {
            ...
            if (typeof Element === 'undefined') {
                ...
                var findMeRect = dom.getBoundingClientRect();
            ...
            if (!Element.prototype.scrollIntoViewIfNeeded) {
                ...
                (outer.start < inner.end && inner.start < outer.end)
                    ...
                    var extent = makePoint(this.offsetWidth, this.offsetHeight);
        ...
        removeNode: function (setting, node) {
            ...
            var tmp_ulObj; var tmp_switchObj; var tmp_icoObj;
        ...
        init: function (obj, zSetting, zNodes) {
            ...
            var zTreeTools = {
                ...
                refresh: function () {
                    ...
                    var nodes = data.nodeChildren(setting, root);
                    data.initRoot(setting);
