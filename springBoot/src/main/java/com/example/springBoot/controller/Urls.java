...
public interface Urls {
    ...
    String DEFAUT_PAGE = "/page-x/cns/index.html";  // 首页
    ...
    // 用户
    String API_USERS          = "/api/users";                    // 添加用戶
    String API_USERS_BY_ID    = "/api/users/{userId}";           // 指定 ID 的用户
    String API_USERS_BY_NAME  = "/api/users/userName";         // 指定用户名的用户
    ...
    // 字典
    String API_DICT = "/api/dict";                      // 插入/查询/修改
    String API_DICT_ID = "/api/dict/{dictId}";          // 删除

    // 学员成绩
    String API_EXAM_RECORD = "/api/exam/record";   // 查询指定道馆学员成绩
    String API_EXAM_RECORD_BY_ID = "/api/exam/record/{recordId}";   // 删除指定学员的成绩

    // 考勤
    String API_CHECKING = "/api/checking";                   // 考勤
    String API_CHECKING_IMPORT = "/api/checking/import";     // 考勤导入
}
